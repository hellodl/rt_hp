...
def get_training_model(weight_decay):
    ...
    stages = 6
    np_limbs = 13
    np_parts = 14 + 1  # add one bkg channel
    ...
    stage1_branch1_out = stage1_block(stage0_out, np_limbs*2, 1, weight_decay)
    stage1_branch2_out = stage1_block(stage0_out, np_parts, 2, weight_decay)
    ...
    for sn in range(2, stages + 1):
        ...
        stageT_branch1_out = stageT_block(x, np_limbs*2, sn, 1, weight_decay)
        stageT_branch2_out = stageT_block(x, np_parts, sn, 2, weight_decay)
...
def get_testing_model():
    ...
    stage1_branch1_out = stage1_block(stage0_out, np_limbs*2, 1, None)
    stage1_branch2_out = stage1_block(stage0_out, np_parts, 2, None)
    ...
    for sn in range(2, stages + 1):
        stageT_branch1_out = stageT_block(x, np_limbs*2, sn, 1, None)
        stageT_branch2_out = stageT_block(x, np_parts, sn, 2, None)
