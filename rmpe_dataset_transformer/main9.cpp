...
int main(int argc, char* argv[]) {
  ...
  const int vec_channels = 30;
  const int heat_channels = 15;
  ...
  getKeys(&keys, datum);
  cout << "From hdf5 file, get keys size is: "<<keys.size() << endl;
  ...
  for (int i=0; i<keys.size(); i++) {
    ...
    cout << "Transforming sample " << i + 1 << "/" << keys.size() << endl;
    ...
    cout<< "The channels of meta is: "<< channels<< endl;
    cout<< "The height of meta is: "<< height<< endl;
    cout<< "The width of meta is: "<< width<< endl;
    cout<< "---------------------------------"<< endl;
    cout << "params.crop_size_x is: "<<params.crop_size_x << endl;
    cout << "params.crop_size_y is: "<<params.crop_size_y << endl;
    cout << "grid_x is: "<<grid_x << endl;
    cout << "grid_y is: "<<grid_y << endl;
    cout<< "---------------------------------"<< endl;
