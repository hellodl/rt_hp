...
int saveTransformed(
  ...
  H5::DataSet* dataset = new H5::DataSet(label_group->createDataSet(  /*label group*/
...
int main(int argc, char* argv[]) {
  ...
  //const int start_label_data = (params.num_parts+1) * channelOffset;  // to do by g.hy
