...
public:
  ...
  */
  ...
  bool augmentation_flip(Mat& img, Mat& img_aug, MetaData& meta, int mode);

  float augmentation_rotate(Mat& img_src, Mat& img_aug, MetaData& meta, int mode);

  float augmentation_scale(Mat& img, Mat& img_temp, MetaData& meta, int mode);

  Size augmentation_croppad(Mat& img_temp, Mat& img_aug, MetaData& meta, int mode);
