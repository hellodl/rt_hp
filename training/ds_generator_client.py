...
class DataGeneratorClient(object):
    ...
    def __init__(self, host, port, nb_parts, nb_limbs, hwm=20, batch_size=10):
        """
        :param host:
        :param port:
        :param hwm:, optional
        ...
        self.vec_num = nb_limbs * 2
        self.heat_num = nb_parts + 1  # add one background channel
    ...
    def gen(self):
        ...
        while True:
            data_img, label = tuple(self._recv_arrays())
